// Versioned, code-reviewed system prompt for the assistant. Treated as code: changes
// go through review and are covered by the prompt eval set. Bump PROMPT_VERSION on edits.
