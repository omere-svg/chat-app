...
import { FORGOT_PASSWORD_FOOTER_CLASS } from './ForgotPasswordFooter.constants.ts'

export function ForgotPasswordFooter(): React.ReactElement {
  return (
    <p className={FORGOT_PASSWORD_FOOTER_CLASS.footer}>
      <Link className={FORGOT_PASSWORD_FOOTER_CLASS.footerLink} to={LOGIN_ROUTE}>
